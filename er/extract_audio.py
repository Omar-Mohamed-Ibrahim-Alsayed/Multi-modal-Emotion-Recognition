...
def extract_audios(video_name):
    input_video_path = f'input/{video_name}.mp4'
    output_audio_path = f'input/{video_name}.wav'
    preprocessed_audio_path = f'input/{video_name}.wav'
    target_time = 3.6  # sec
...
# extract_audios("01-01-03-02-01-01-16")