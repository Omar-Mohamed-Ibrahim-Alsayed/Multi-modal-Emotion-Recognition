...
def weights_initialize(model):
        ...
        torch_state_dict = torch.load('../weights/pytorch_model.bin', map_location=torch.device('cuda'))
...
class MultiModalCNN(nn.Module):
    def __init__(self):
        ...
        init_feature_extractor(self.visual_model, '../weights/EfficientFace_Trained_on_AffectNet7.pth')
