...
class SpeechToTextProcessor:
    def __init__(self):
        ...
        arabic = False
        if not arabic:
            self.model_path = r'STT\\vosk-model-small-en-us-0.15'  # Path to the Vosk model
        else:
            self.model_path = r'.\STT\vosk-model-ar-mgb2-0.4'
    ...
    def _transcribe_audio_file(self, audio_file_path):
        ...
        try:
            ...
            if wf:
                wf.close()
            if converted_audio_file_path != audio_file_path and os.path.exists(converted_audio_file_path):
...
# processor.record_audio(10, 'ay_7aga.wav')
# # processor.transcribe_audio_file('ay_7aga.wav')
# results = processor.transcribe_all('2024-06-24_04-43-40')
# print(results)
