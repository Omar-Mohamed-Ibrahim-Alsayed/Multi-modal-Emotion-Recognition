...
class QuestionsUI(QtWidgets.QWidget):
    ...
    def open_camera(self):
        ...
        question_no = self.QuestionsGenerator.get_index()
        self.camera_thread = VideoCaptureThread(question_no=question_no)  # Pass question_no here
        ...
        self.camera_thread.set_outfile(str(question_no) + ".mp4")
        self.camera_thread.start()
        while not self.camera_thread.isRunning():
            continue
        self.audio_thread.set_outfile(str(question_no) + ".wav")
